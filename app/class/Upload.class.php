<?php
	class Upload{
		...
		public function salvar($nome, $tipo=null){
			$extensao = $this->getExtensao();

			//gera um nome para a imagem
			if($tipo == null) $novo_nome = $nome. '.' . $extensao;
			else $novo_nome = $nome .'_'. $tipo. '.' . $extensao;
